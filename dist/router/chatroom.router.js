...
const chatroom_controller_2 = require("../controller/chatroom.controller");
exports.chatRoomrouter = express_1.default.Router();
exports.chatRoomrouter.use(user_auth_1.authenticateUser);
exports.chatRoomrouter.post("/create", chatroom_controller_2.createChatRoom);
exports.chatRoomrouter.get("/join?", chatroom_controller_2.loginChatRoom);
exports.chatRoomrouter.get("/myrooms", chatroom_controller_2.getChatRooms);
